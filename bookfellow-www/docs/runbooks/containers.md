# Bookfellow — NAS lab containers (lab slug still `projectcodex`)
...
**Carve-out:** only TrueNAS app slug **`projectcodex`** (rename cutover later). Fleet prune / MAM / other compose stays Work-only.
