...
3. Www outbound (if present): `/mnt/DataStore/Ventures/project-codex/codex-www/docs/business-feed.md` — harvest into `docs/` + [dashboard/product-signals.md](.cursor/dashboard/product-signals.md) when new
