...
2. **Long-tail economics** — if most demand is obscure titles, buy-cost stays high and amortization fails. Metering + unlock permanence + catalog reuse must be stress-tested in foundation packet.
