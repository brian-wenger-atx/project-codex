...
**Final home:** production-grade **cloud** (vendor TBD). **NAS** (`projectcodex` on TrueNAS) is **lab only** — same service graph, portable compose.
...
| Interim host | Docker Compose on NAS (`projectcodex`, LAN `:4003`) |
