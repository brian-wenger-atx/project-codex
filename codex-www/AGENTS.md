# codex-www — agent scope

**Job:** Greenfield product site / app (later Builds).

## May write

This folder only (`codex-www/`), plus the **`projectcodex`** container carve-out:
...
5. `docs/git.md` — monorepo remote https://github.com/brian-wenger-atx/project-codex
