...
|------|------|------|--------|
| www-foundation-stack | foundation | `/mnt/DataStore/home/agent/.cursor/plans/www_foundation_stack_71f9027b.plan.md` | **P0+P1 shipped** → **P2 fleshed (ready to Build)** — Next on `:4003` + Redis |

Lab: `http://192.168.1.200:4003/` · stack [`docs/stack.md`](../docs/stack.md) · containers [`docs/runbooks/containers.md`](../docs/runbooks/containers.md) · git [`docs/git.md`](../docs/git.md) → https://github.com/brian-wenger-atx/project-codex

**Next requirement (backlog):** [mobile-first web — iPhone/iPad required from day 1](.cursor/backlog.md) — bake into P2+; native iOS/Android = other silo (not www).

## Queued

_(P3–P4+ stay inside foundation plan until P2 lands; SP1–SP6 are separate product plans)_
...
| — | www-foundation-stack **P1** | foundation | same | P1 2026-07-20 (`projectcodex` :4003) |
...
- **Sent to business (2026-07-20):** foundation **baseline** (P0 stack + P1 lab) written to [`docs/business-feed.md`](../docs/business-feed.md) even though `www-foundation-stack` is not fully shipped — harvest on next business session; www-only cannot edit `www-feed.md`
